    ...
    products: [
      {
        ...
        classEN: "",
        consumption: "0.08–0.1 l/m² (diluted)",
        descKey: "p_4180_desc",
        usage: ["walls", "floors", "interior", "exterior"],
        substrates: ["concrete", "cement_screed", "plaster", "wood", "gypsum"],
        notes: "Yellow pigment for application control. Dilute 1:1 to 1:3 depending on substrate absorbency. Use concentrated on wood. Apply with brush or spray gun.",
        tempRange: "+10…+18 °C",
        dryTime: "1–2 h",
        hazard: ["H315", "H318"]
      },
    ...
    products: [
      {
        ...
        classEN: "ETAG 022",
        consumption: "1.0–1.6 kg/m² (min 2 layers)",
        descKey: "p_4400_desc",
        usage: ["walls", "floors", "wet_rooms", "interior", "exterior"],
        notes: "Ready-mixed polymer membrane. Apply min 2 layers cross-wise. Use with seal bands, pipe collars, corners. Frost-resistant after hardening.",
        dryTime: "1–2 h per layer",
        tileReady: "6–12 h",
        substrates: ["concrete", "cement_screed", "lightweight_block", "plaster", "gypsum", "brick", "wood"],
        hazard: ["H315"]
      },
      {
        id: "4500",
    ...
    products: [
      {
        ...
        classEN: "C1TE S2",
        consumption: "1.6 kg/m² (walls), 2.2 kg/m² (floors)",
        descKey: "p_zfix_desc",
        ...
        color: "white",
        notes: "Premium adhesive. White cement base — ideal for glass mosaic & marble. S2 highest flexibility. Extra light — covers 35% more area. Not for outdoor floors.",
        hazard: ["H315", "H318"]
      },
      {
        id: "3000",
        ...
        classEN: "C1T",
        consumption: "2.5–6.0 kg/m²",
        descKey: "p_3000_desc",
        usage: ["walls", "floors", "interior", "exterior", "wet_rooms"],
        tileSize: "Standard absorbing tiles (water absorption ≥3%)",
        substrates: ["concrete", "cement_screed", "lightweight_block", "plaster"],
        color: "grey",
        notes: "Economy standard adhesive. Grey, moisture- and frost-resistant. Layer 3–10 mm. Indoor/outdoor, wet and dry zones. For absorbing tiles only (≥3% water absorption). Available in UA, EE, LT, LV markets.",
        regions: ["UA", "EE", "LT", "LV"],
        hazard: ["H315", "H318"]
      },
      {
        id: "3110",
        name: "3110 unifix",
        type: "Universal white tile adhesive",
        classEN: "C2TE S1",
        consumption: "2.0 kg/m² (walls), 3.5 kg/m² (floors)",
        descKey: "p_3110_desc",
        usage: ["walls", "floors", "interior", "exterior", "heated_floor", "wet_rooms"],
        tileSize: "Normal sized tiles",
        substrates: ["concrete", "cement_screed", "plaster", "gypsum", "old_tile", "waterproofing", "painted_surface", "wood"],
        color: "white",
        hazard: ["H315", "H318"]
      },
      {
        id: "3130",
        name: "3130 superfix",
        type: "Flexible white tile adhesive",
        classEN: "C2TE S2",
        consumption: "2.5 kg/m² (walls), 3.5 kg/m² (floors)",
        descKey: "p_3130_desc",
        usage: ["walls", "floors", "interior", "exterior", "heated_floor", "wet_rooms", "pools", "facade"],
        tileSize: "Normal and large tiles",
        substrates: ["concrete", "cement_screed", "old_tile", "waterproofing", "painted_surface"],
        color: "white",
        notes: "S2 highest deformability. For facades, swimming pools, terraces, fireplaces (up to 100°C). White cement — ideal for marble/mosaic.",
        hazard: ["H315", "H318"]
      },
      {
        id: "3250",
        name: "3250 gigafix floor",
        type: "Self-levelling floor adhesive",
        classEN: "C2E S2",
        consumption: "4.0 kg/m² (floor average)",
        descKey: "p_3250_desc",
        usage: ["floors", "interior", "exterior", "heated_floor", "terraces", "balconies"],
        tileSize: "Normal, large and very large tiles",
        substrates: ["concrete", "cement_screed", "old_tile", "waterproofing", "painted_surface"],
        color: "white",
        tempRange: "+10…+20 °C",
        notes: "S2 highest deformability. Self-levelling — 100% coverage. For large format tiles on floors. Rapidly hardening. FLOOR ONLY — not for walls.",
        hazard: ["H315", "H318"]
      },
      {
        id: "3230",
        ...
        color: "white",
        notes: "White alkali cement, rapid set — groutable after 1–2 hours. Frostproof, waterproof. For all tiles, clinkers, natural stones. Layer 3–10 mm.",
        hazard: ["H315", "H318"]
      },
      {
        id: "lightfix",
        ...
        usage: ["walls", "floors", "interior", "exterior", "wet_rooms", "heated_floor"],
        tileSize: "All types of ceramic tiles, clinker, mosaic, natural stones",
        substrates: ["concrete", "plaster", "gypsum", "old_tile", "painted_surface", "cement_screed"],
        color: "grey",
        notes: "Extra light — covers 25%+ more area. Low dust. Frostproof, waterproof, flexible. Grey — not recommended for thin/light marble tiles due to color translucency.",
        hazard: ["H315", "H318"]
      },
      {
        id: "3600",
        name: "3600 multicrete",
        type: "Highly elastic multi-substrate adhesive",
        classEN: "Special",
        consumption: "Depends on trowel",
        descKey: "p_3600_desc",
        usage: ["walls", "floors", "interior", "wet_rooms", "heated_floor"],
        tileSize: "All sizes",
        substrates: ["concrete", "gypsum", "wood", "plywood", "chipboard", "old_tile", "painted_surface", "metal", "plastic"],
        color: "white",
        notes: "Cement-based, highly elastic white adhesive. For substrates with large deformation: plasterboard, chipboard, plywood, old tiles, painted surfaces, plastic laminate, rust-protected steel. Also for fireplaces and heated floors.",
        hazard: ["H315", "H318"]
      },
      {
        id: "stonefix",
        name: "stonefix",
        type: "Paving stone adhesive mortar",
        classEN: "",
        consumption: "2.5–4.0 kg/m²",
        descKey: "p_stonefix_desc",
        usage: ["floors", "exterior"],
        tileSize: "Paving stones, natural stone, cut slate",
        substrates: ["concrete", "cement_screed", "asphalt"],
        color: "grey",
        notes: "Cement-based, frost- and water-resistant, polymer-reinforced. For paving stones, natural stone, cut slate outdoors. Not a standard tile adhesive (no EN 12004 classification).",
        hazard: ["H315", "H318"]
      },
      {
        id: "3650",
      ...
      },
      {
        ...
        substrates: ["concrete", "lightweight_block", "brick", "old_tile", "plaster"],
        color: "grey",
        notes: "Heat-resistant. For building fireplaces, pizza ovens, chimneys. Fixing fire tubes, plastering firewalls.",
        hazard: ["H315", "H318"]
      }
    ]
  },
    ...
    products: [
      {
        ...
        jointWidth: "2–10 mm",
        colors: 40,
        notes: "Rapid-hardening, water-repellent, anti-mold. Highest class CG2 WA. 40+ colors. Does not contain Portland Cement.",
        hazard: ["H315", "H318"]
      },
      {
        id: "sc",
        ...
        jointWidth: "2–10 mm",
        colors: 34,
        notes: "Polymer-reinforced, rapid-hardening, flexible, frost- and waterproof. CG2 WA class. 34 colors. For facades, terraces, balconies, heated floors.",
        hazard: ["H315", "H318"]
      },
      {
        id: "classic",
        ...
        jointWidth: "2–15 mm",
        colors: 10,
        notes: "White cement based, polymer-reinforced, waterproof, frostproof. For indoor/outdoor, wet and dry rooms. Various colors.",
        hazard: ["H315", "H318"]
      },
      {
        id: "supersil",
...
const SYSTEM_SOLUTIONS = {
  bathroom_standard: {
    ...
    steps: [
      ...
      { step: 3, nameKey: "step_adhesive", product: "3130", note: "C2TE S2 for wet rooms" },
  ...
  bathroom_large_tile: {
    ...
    steps: [
      ...
      { step: 3.1, nameKey: "step_adhesive_walls", product: "3130", note: "S2 for walls" },
  ...
  wooden_floor: {
    ...
    steps: [
      ...
      { step: 4, nameKey: "step_adhesive", product: "3130", note: "S2 flexible" },
  ...
  heated_floor: {
    ...
    steps: [
      ...
      { step: 3, nameKey: "step_adhesive", product: "3130", note: "S2 compensates thermal expansion" },
      { step: 4, nameKey: "step_grout", product: "sce" },
